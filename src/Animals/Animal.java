...
/**
 * Animal.Java
 * This program is used to create a new object of type animal with the name,
 * weight, & age parameters given by the user.
 * @author willp
 */
public class Animal {
    /**
 ...
 * @return a string telling the user the name, weight, and age of the animal
 */
